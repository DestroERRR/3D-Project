...
color gifObjectColor = #FE8181; //rgb is 254, 129, 129
...
//Character life, score and shooting timer
int charLife; 
int charScore; 
int shotTimer = 30;
int threshold = 30; 
...
int frameNumber = 11;
int frame = 0;
PImage[] gif = new PImage[frameNumber];
...
void setup() {
  ...
  for(int i = 0; i < frameNumber; i++){
   String zero = "frame_" + frame + i + "_delay-0.05s.gif"; 
   gif[i] = loadImage(zero);
